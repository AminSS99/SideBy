...
const GlassCard = ({ children, className, glowColor }: GlassCardProps) => (
  <div
    className={cn(
      "relative overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md p-6 transition-all duration-300 hover:border-white/[0.12] hover:bg-white/[0.05]",
