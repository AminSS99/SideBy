    ...
    <div className="max-w-7xl mx-auto px-6 mb-24">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest">{`Live statistics from the ${brand.networkName}`}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {trends.map((trend, i) => (
          <GlassCard
            key={i}
            className="hover:border-orange-500/30 transition-all cursor-pointer group"
          >
            ...
            <div className="flex items-center justify-between gap-2 mb-4">
              ...
              <span className="text-sm font-black italic tracking-tight truncate text-right">
                {trend.pair[1]}
              </span>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/5">
              <div className="text-[10px] font-bold text-white/40 uppercase">
                AI Fav: <span className="text-white">{trend.winner}</span>
              </div>
