...
import { Sliders, Trophy, Save, Trash2, HelpCircle, Activity, FolderOpen, Lock } from "lucide-react";
import gsap from "gsap";
import { useGSAP } from "@gsap/react";
import { cn } from "@/lib/utils";
import type { ComparisonData } from "./types";
import { panelClass } from "./constants";
import { useDecisionMatrix, type DecisionMatrixRecord } from "./useDecisionMatrix";
...
export const DecisionMatrixPanel = ({ 
  ...
  const {
    ...
    handleDeleteMatrix,
    handleLoadMatrix
  } = useDecisionMatrix(result, comparisonId);
