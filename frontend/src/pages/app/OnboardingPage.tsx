...
const PRODUCT_LOGOS: Record<string, string> = {
  ...
  sideby: "/sideby.ico?v=20260728-real",
};
...
const getProductLogo = (product: EcosystemProduct) => {
  ...
  return PRODUCT_LOGOS[product.slug] || "/sideby.ico?v=20260728-real";
};
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl">
        <header className="ob-hero mb-8 flex items-center justify-between">
          <Link to="/" className="group flex items-center gap-3">
            <img src="/sideby.ico?v=20260728-real" alt="SideBy" className="h-9 w-9 rounded-xl object-contain shadow-lg" />
            <div>
