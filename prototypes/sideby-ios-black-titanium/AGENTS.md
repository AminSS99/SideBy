...
### SideBy visual direction

- The selected target is the third premium concept: a black-titanium split A/B decision instrument.
- Preserve its restrained near-monochrome palette, central dividing rule, small copper/cyan A/B identifiers, tactile material texture, and sparse information hierarchy.
- Keep the useful material character but avoid ornamental hardware details that reduce usability, such as decorative screws on controls.
- Avoid generic AI-dashboard styling, neon outlines, bright orange gradients, oversized marketing headlines, excessive cards, and glow effects.
