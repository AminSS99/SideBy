  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-8 bg-white/5 rounded-3xl border border-white/10 mb-12">
      <div className="col-span-full">
        <h3 className="text-sm font-black italic uppercase tracking-widest text-blue-400 mb-2">Neural Calibration</h3>
      ...
      {metrics.map((metric) => (
        <div key={metric} className="space-y-3">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs font-black text-blue-400">{(weights[metric] * 10).toFixed(0)}x</span>
          </div>
          <Slider
